...
public class App {
    public static void main(String[] args) {
        ...
        VideoPipelineFacade videoPipelineFacade = new VideoPipelineFacade(new Decoder(), new FilterEngine(), new Encoder());
        Path path = videoPipelineFacade.process(Path.of("in.mp4"), Path.of("out.mp4"), 0.5);
